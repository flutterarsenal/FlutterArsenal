---
title: flutter_offline
name: flutter_offline
category: Free
tag: UI Helper
excerpt: A tidy utility to handle offline/online connectivity like a Boss. It provides support for both iOS and Android platforms (offcourse).
teaser: https://raw.githubusercontent.com/jogboms/flutter_offline/master/screenshots/demo_1.gif
github: https://github.com/jogboms/flutter_offline
license:
 name: MIT License
