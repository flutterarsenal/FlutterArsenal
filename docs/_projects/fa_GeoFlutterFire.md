---
title: GeoFlutterFire
name: GeoFlutterFire
category: Free
tag: firestore
excerpt: ":fire:GeoFlutterFire:fire: is an open-source library that allows you to store and query firestore documents based on their geographic location."
github: https://github.com/DarshanGowda0/GeoFlutterFire
license:
 name: MIT License
...
owner:
 profile_image: https://avatars1.githubusercontent.com/u/10462504?v=4
 name: DarshanGowda0
 on_date: June 27, 2019
contributors:
 -
   image: https://avatars2.githubusercontent.com/u/899180?v=4
   url: https://github.com/FredvanRijswijk
 -
   image: https://avatars1.githubusercontent.com/u/7477504?v=4
   url: https://github.com/felipecesar42
 -
   image: https://avatars1.githubusercontent.com/u/10462504?v=4
   url: https://github.com/DarshanGowda0
 -
   image: https://avatars1.githubusercontent.com/u/17554820?v=4
   url: https://github.com/anatter
 -
   image: https://avatars2.githubusercontent.com/u/18518045?v=4
   url: https://github.com/JonasTillges
registered_by:
