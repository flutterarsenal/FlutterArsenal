---
title: flutter_camera_ml_vision
name: flutter_camera_ml_vision
category: Free
tag: firebase
excerpt: "A flutter widget that show the camera stream and allow ML vision recognition on it, it allow you to detect barcodes, labels, text, faces..."
github: https://github.com/rushio-consulting/flutter_camera_ml_vision
license:
 name: MIT License
...
owner:
 profile_image: https://avatars3.githubusercontent.com/u/46170213?v=4
 name: rushio-consulting
 on_date: June 27, 2019
contributors:
 -
   image: https://avatars1.githubusercontent.com/u/2970449?v=4
   url: https://github.com/jaumard
 -
   image: https://avatars3.githubusercontent.com/u/5323628?v=4
   url: https://github.com/bwnyasse
 -
   image: https://avatars1.githubusercontent.com/u/5434752?v=4
   url: https://github.com/Kleak
 -
   image: https://avatars3.githubusercontent.com/u/13658554?v=4
   url: https://github.com/saddy001
registered_by:
